...
На широком экране параметры XHTTP снова собраны в компактные строки, а выбор клиентского XHTTP mode вынесен в сворачиваемый блок «Экспертные настройки XHTTP». Новый отдельный SG-Panel XMUX-блок и Gecko остаются без изменений. Ниже AmneziaWG и Mihomo занимают две сбалансированные колонки; на узком экране они складываются вертикально.
