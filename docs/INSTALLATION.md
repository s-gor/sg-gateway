...
> **0.1.0-022.05 = LIVE.** Это текущая опубликованная линия SG-Gateway. Историческая `0.1.0-021.12` сохранена как FINAL AWG2 baseline. Следующая development-линия — `0.1.0-022.06`.
...
## Текущая схема чистой установки
