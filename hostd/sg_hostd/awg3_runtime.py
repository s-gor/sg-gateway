...
def _ensure_credentials() -> None:
    ...
    with cr.connect() as connection:
        devices = connection.execute(
            ...
            JOIN device_credentials awg2 ON awg2.device_id = d.id AND awg2.engine = 'amneziawg'
            LEFT JOIN device_credentials awg3 ON awg3.device_id = d.id AND awg3.engine = 'amneziawg3'
        ...
        for row in devices:
            ...
            connection.execute(
                ...
                """,
                (device_id, public_key, json.dumps(config, ensure_ascii=False, sort_keys=True)),
            )
