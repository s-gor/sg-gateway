...
Версия `0.1.0-021.9` собрала полную переработку управления клиентами и устройствами, персональные подписки, расширенный экспорт Mieru, новые QR-коды, принятую мобильную навигацию и понятные подписи Routing. Ниже перечислены все изменения версии.
...
- Добавлен отдельный контракт версии 021.9 для проверки подписки, Mieru URI/JSON, обоих QR, мобильной навигации, редактирования и сохранения неизменённых реквизитов.
